...
4. [注意**叶子**树的最小深度](https://leetcode-cn.com/problems/minimum-depth-of-binary-tree/)
5. [判断是否是完全二叉树](https://leetcode-cn.com/problems/check-completeness-of-a-binary-tree/) 层次遍历 遇到null后只能遇到null，不然就返回false
